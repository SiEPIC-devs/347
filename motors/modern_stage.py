...
class StageControl(MotorHAL):
    ...
    # MOVEMENT
    async def move_absolute(self, position, velocity=None, wait_for_completion=True) -> bool:
        """
    ...
    async def move_relative(self, distance, velocity=None, wait_for_completion=True) -> Optional[float]:
        """
    ...
    # Configuration
    async def set_velocity(self, velocity) -> bool:
        """
    ...
    async def set_acceleration(self, acceleration) -> bool:
        """
    ...
    # Home and limits
    async def home(self, direction=0) -> bool:
        """
        Home the axis
        """
        def _home():
