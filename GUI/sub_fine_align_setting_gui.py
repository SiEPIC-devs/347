...
class add_btn(App):
    ...
    def construct_ui(self):
        fine_align_setting_container = StyledContainer(variable_name="fine_align_setting_container", left=0, top=0, height=150, width=295)

        StyledLabel(container=fine_align_setting_container, text="X Length", variable_name="x_length_lb", left=0, top=10,
        ...
        StyledLabel(container=fine_align_setting_container, text="um", variable_name="x_length_um", left=155, top=10,
        ...
        StyledSpinBox(container=fine_align_setting_container, variable_name="x_step_in", left=80, top=42,
                      width=50, height=24, min_value=-1000, max_value=1000, step=0.1, position="absolute")
        StyledLabel(container=fine_align_setting_container, text="um", variable_name="x_step_um", left=155, top=42,
                    width=20, height=25, font_size=100, flex=True, justify_content="left", color="#222")
