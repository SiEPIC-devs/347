...
# Embedded file name: /home/pi/Desktop/new GUI/File Import/coordinates.py
...
class coordinates:
    ...
    def read_file(self):
        ...
        with open(self.path) as self.coordinate_file:
            ...
            file_contents = file_contents[startingline[:None]]
            ...
            for line in file_contents:
                try:
                    ...
                    wavelength = line[3]
                    device_type = line[4]
                    device_name = "_".join(line[5[:None]])
                    data = [
                     number, coordinate, 
    ...
    def apply_transform(self, device_numbers, xy_motor1, xy_motor2, xy_motor3):
        ...
        while 1:
            ...
            transformation_matrix = solution[None[:9]]
            transformation_matrix = transformation_matrix.reshape([3, 3])
            displacement_vector = solution[9[:None]]
            large_error = 0
