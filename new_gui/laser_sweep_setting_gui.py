...
class add_btn(App):
    ...
    def construct_ui(self):
        laser_sweep_container = StyledContainer(variable_name="laser_sweep_container", left=0, top=0, height=210, width=240)
        ...
        StyledTextInput(container=laser_sweep_container, variable_name="speed_in", left=95, top=10,
        ...
        StyledLabel(container=laser_sweep_container, text="Power", variable_name="laser_power_lb", left=0, top=42,
                    width=85, height=25, font_size=100, flex=True, justify_content="right", color="#222")
        StyledTextInput(container=laser_sweep_container, variable_name="power_in", left=95, top=42,
                        width=65, height=24, position="absolute")
        ...
        StyledLabel(container=laser_sweep_container, text="Step Size", variable_name="step_size_lb", left=0, top=74,
                    width=85, height=25, font_size=100, flex=True, justify_content="right", color="#222")
        StyledTextInput(container=laser_sweep_container, variable_name="step_size_in", left=95, top=74,
                        width=65, height=24, position="absolute")
        ...
        StyledLabel(container=laser_sweep_container, text="Start Wvl", variable_name="start_wvl_lb", left=0, top=106,
                    width=85, height=25, font_size=100, flex=True, justify_content="right", color="#222")
        StyledTextInput(container=laser_sweep_container, variable_name="start_wvl_in", left=95, top=106,
                        width=65, height=24, position="absolute")
        ...
        StyledLabel(container=laser_sweep_container, text="Stop Wvl", variable_name="stop_wvl_lb", left=0, top=138,
                    width=85, height=25, font_size=100, flex=True, justify_content="right", color="#222")
        StyledTextInput(container=laser_sweep_container, variable_name="stop_wvl_in", left=95, top=138,
                        width=65, height=24, position="absolute")
